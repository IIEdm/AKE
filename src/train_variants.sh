...
lambda_2=1.0
mu=1.0
CUDA_VISIBLE_DEVICES=0 python AKE_MR.py --sour_lang $sour_lang --tar_lang $tar_lang --save_dir $save_dir \
 ...
 --D_iter $D_iter --clipping_parameter $clipping_parameter --rbf $rbf --lambda_1 $lambda_1 --lambda_2 $lambda_2 --mu $mu 
